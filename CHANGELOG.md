...
### Fixed
- Fixed db-init container failure during installation by adding `--accept-data-loss` and `--skip-generate` flags to `prisma:push` command for non-interactive Docker execution
